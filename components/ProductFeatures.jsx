const ProductFeatures = ({ product }) => {
  return (
    <div className=" lg:flex lg:gap-[11.3%] ">
      ...
      <div className="mt-[8.8rem]  sm:mt-[12rem] sm:flex sm:w-[54.9rem] sm:justify-between lg:m-0 lg:w-[31.5%] lg:flex-col lg:justify-start">
